...
# Virtual PS2 KEYBOARD:
set_property -dict { PACKAGE_PIN E17   IOSTANDARD LVCMOS33 } [get_ports { ps2_data_i }]; # virtual PS/2 keyboard data input
set_property -dict { PACKAGE_PIN D17   IOSTANDARD LVCMOS33 } [get_ports { ps2_clk_i }];  # virtual PS/2 keyboard clock input
#virtual Buttons
